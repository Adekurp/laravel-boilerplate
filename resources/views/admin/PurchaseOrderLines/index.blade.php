...
@section('content')
    ...
    <div class="row">
        <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th>@sortablelink('product', __('views.admin.purchase.order.lines.index.table_header_0'), ['page' => $purchaseOrderLines->currentPage()])</th>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin.purchase.order.lines.destroy', [$purchaseOrderLine->id]) }}"
                                class="btn btn-xs btn-danger product_destroy" data-toggle="tooltip" data-placement="top"
                                data-title="{{ __('views.admin.purchase.order.lines.index.delete') }}">
