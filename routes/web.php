...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => 'admin'], function () {
    ...
    Route::post('purchase-order-lines/{id}/update', 'PurchaseOrdercontroller@getPurchaseOrderLineUpdate')->name('purchase.order.lines.update');
    Route::post('purchase-order-lines/create', 'PurchaseOrdercontroller@getPurchaseOrderLineInsert')->name('purchase.order.lines.insert');
